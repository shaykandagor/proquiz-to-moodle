...
function generateQuizXml(outputDir) {
    const quizXml = xmlbuilder.create('activity', { encoding: 'UTF-8' })
        ...
        .ele('quiz', { id: '' })
            ...
            .ele('timeclose', '0').up()
            .ele('timelimit', '0').up()
            .ele('overduehandling', 'autosubmit').up()
            .ele('graceperiod', '0').up()
            .ele('preferredbehaviour', 'deferredfeedback').up()
            .ele('canredoquestions', '0').up()
            .ele('attempts_number', '0').up()
            .ele('attemptonlast', '0').up()
            .ele('grademethod', '1').up()
            .ele('decimalpoints', '2').up()
            .ele('questiondecimalpoints', '-1').up()
